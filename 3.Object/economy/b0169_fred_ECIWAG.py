...
series_id = "ECIWAG"  # Employment Cost Index: Wages and Salaries: Private Industry Workers
...
if data:
    ...
    plt.plot(df["date"], df["value"], label="Employment Cost Index (ECIWAG)", color="blue")
